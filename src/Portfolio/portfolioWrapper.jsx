...
const PortfolioWrapper = (props: portfolioProps) => {
    ...
    useEffect(() => {
        setIsVisible(true); // Set visibility only after the component mounts
    }, []);
    ...
    return (
        <div className="p-6 portfolio-image-wrapper">
            ...
            <div className="column">
                <div className="row">
                    <div className="col-12 text-center">Title: Title</div>
                </div>
                <hr />
                <div className="row portfolio-image-text">
